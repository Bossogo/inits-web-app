  ...
  return (
    <>
        <div id="welcome-section" className="container-fluid">
            <Container className='cover p-md-5'>
                <Row>
                    <Col>
                    ...
                    <Col>
                        ...
                        <p> I am truly honoured to serve our great nation in this capacity as Minister of Communications, Innovation & Digital Economy as we work towards actualising the Renewed Hope Agenda of President Bola Ahmed Tinubu (GCFR).
                        <br/><br/>
                        ...
                        <br/><br/>
                        To achieve this, with the input of critical stakeholders, we have co-created a Strategic Blueprint which will serve as a framework to guide our activities and ensure that we deliver on set targets for the prosperity of all Nigerians.</p>
